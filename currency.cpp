...
char * bitcoinf(double value)   { return currency64((value * 1000000LL), 6,  '.',  ',',  'B'); }
char * dollarf(double value)    { return currency64((value * 100LL), 2,  '.',  ',',  '$'); }
char * eurof(double value)      { return currency64((value * 100LL), 2,  ',',  '.',  'E'); }
char * poundf(double value)     { return currency64((value * 100LL), 2,  ',',  '.',  'P'); }
char * roublesf(double value)   { return currency64((value * 100LL), 2,  ',',  '.',  'R'); }
char * yenf(double value)       { return currency64((value * 100LL), 2,  '.',  ',',  'Y'); }
char * yuanf(double value)      { return currency64((value * 100LL), 2,  '.',  ',',  'Y'); }
...
char * BTC(int64_t value)       { return currency64(value, 6,  '.',  ',',  'B'); }
char * USD(int64_t value)       { return currency64(value, 2,  '.',  ',',  '$'); }
char * EUR(int64_t value)       { return currency64(value, 2,  ',',  '.',  'E'); }
char * GBP(int64_t value)       { return currency64(value, 2,  ',',  '.',  'P'); }
char * RUB(int64_t value)       { return currency64(value, 2,  ',',  '.',  'R'); }
char * JPY(int64_t value)       { return currency64(value, 2,  '.',  ',',  'Y'); }
char * CNY(int64_t value)       { return currency64(value, 2,  '.',  ',',  'Y'); }

char * BTC(double value)        { return currency64((value * 1000000LL), 6,  '.',  ',',  'B'); }
char * USD(double value)        { return currency64((value * 100LL), 2,  '.',  ',',  '$'); }
char * EUR(double value)        { return currency64((value * 100LL), 2,  ',',  '.',  'E'); }
char * GBP(double value)        { return currency64((value * 100LL), 2,  ',',  '.',  'P'); }
char * RUB(double value)        { return currency64((value * 100LL), 2,  ',',  '.',  'R'); }
